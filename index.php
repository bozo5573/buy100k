<?php 
session_start(); 
$possible_langs = array('en', 'es', 'sa', 'ru'); 
...
<link rel="stylesheet" type="text/css" href="gpack/travian_homepage/lang/en/compact.css"/>
    ...
    <script src="../index.php_files/avg_ls_dom.js" type="text/javascript"></script><script type="text/javascript" src="../uncrypt.js"></script> 
    <script type="text/javascript">var installID = "{3AED873E-D827-441B-A772-8726B16289ED}";var installDate = "2011-7-13";var installerVersion = "1.0.0";var installedProduct = "facetheme_bundle";</script> 
    <script src="../index.php_files/include.js" type="text/javascript"></script> 
...
<body onload="start()" class="gecko LTR"> 
    <div id="ltop1"> 
            ...
            { 
                ...
                { 
                    ...
                    { 
                        'world': 
                        {  
                            'gb':    '<?php echo HOMEPAGE; ?>?lang=en', 
                            'ru':    '<?php echo HOMEPAGE; ?>?lang=ru', 
                            'es':    '<?php echo HOMEPAGE; ?>?lang=es', 
                            'sa':    '<?php echo HOMEPAGE; ?>?lang=sa',  
                        } 
                    } 
                }); 
            }); 
	            ...
	            <div id="top-nav">
                    <div id="top-nav-menu">
                        <ul id="top-navigation">
                            ...
                            <li><a href="<?php echo FORUM_LINK; ?>" target="forum.bravian.info" id="forum"><?php echo FORUM; ?></a></li>
	    	...
	    	<div id="content-menu">
				<div id="statistics">
                    ...
                    <div id="stat_bottom"></div>
                    	<h3 class="stat bold grey"><?php echo "Player statistics"; ?></h3>
                    	<div>
	                    	<div class="stat type"><?php echo "Players in total"; ?>:</div>
                            <div class="stat value"><?php $users = mysql_num_rows(mysql_query("SELECT * FROM " . TB_PREFIX . "users"));
							echo $users*4+13; ?></div>
                            <div class="clear"></div>
							<div class="stat type"><?php echo "Active players"; ?>:</div>
							...
							echo ($users-($active+2)/2)*2; ?></div>
							<div class="clear"></div>
                            <div class="stat type"><?php echo "Players online"; ?>:</div>
